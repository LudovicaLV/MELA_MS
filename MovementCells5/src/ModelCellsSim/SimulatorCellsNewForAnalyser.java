...
public class SimulatorCellsNewForAnalyser {
...
//			}
		...
		//System.out.println(nameActions.get(action_index) + " " + Type.get(action_index) + " " + WhatToPrintA + " " + WhatToPrintP);
		
		
		if (Type.get(action_index) == Action.ACTION_TYPE_NoInf) {
			if (WhatToPrintA == "SpatialAction "){
				writer_meta.print("nope");
			}else{
				writer_meta.print(agentPositionArray.get(action_index).get(0) + " " + agentPositionArray.get(action_index).get(1) + " x x");
			}
		}
		if (Type.get(action_index) == Action.ACTION_TYPE_Inf) {
			if (WhatToPrintA == "SpatialAction "){
			...
			writer_meta.print(agentPositionArray.get(action_index).get(0) + " " + agentPositionArray.get(action_index).get(1) + " ");
			}
		if (WhatToPrintP == "SpatialAction "){
			
//			System.out.println("Check: ");
//			System.out.println(nameActions.get(action_index));
//			System.out.println(action_index);
//			System.out.println(passiveAgentPositionArray.get(action_index));
//			System.out.println(newPositionArrayP.get(action_index));
//			System.out.println(passiveAgentPositionArray.get(action_index).get(0));
//			System.out.println(passiveAgentPositionArray.get(action_index).get(1));
//			System.out.println(newPositionArrayP.get(action_index).get(0));
//			System.out.println(newPositionArrayP.get(action_index).get(1));
			
			
			
			
			writer_meta.print(passiveAgentPositionArray.get(action_index).get(0) + " " + passiveAgentPositionArray.get(action_index).get(1) + " " + newPositionArrayP.get(action_index).get(0) + " " + newPositionArrayP.get(action_index).get(1) + " ");
		}else{
			writer_meta.print(passiveAgentPositionArray.get(action_index).get(0) + " " + passiveAgentPositionArray.get(action_index).get(1));
		  }
		}
